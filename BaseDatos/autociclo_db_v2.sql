...
ALTER TABLE `USUARIOS`   MODIFY `id_usuario`     INT NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
ALTER TABLE `CLIENTES`   MODIFY `id_cliente`     INT NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
