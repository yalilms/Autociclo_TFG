...
(() => {
  ...
  class DeckStage extends HTMLElement {
    ...
    _onFullscreenChange() {
      // Si el usuario sale de pantalla completa con Escape, sincronizar estado
      if (!document.fullscreenElement && !document.webkitFullscreenElement && this._presenting) {
